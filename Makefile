...
SYSTEMD_UNIT := $(ROOT_DIR)/mothership.service
...
install: ##@other Start and enable service
	...
	@ln -sf $(SYSTEMD_UNIT) /etc/systemd/system/mothership.service
	@systemctl daemon-reload
	@systemctl start mothership
	@systemctl enable mothership

uninstall: confirm ##@other Stop and disable service
	@systemctl stop mothership
	@systemctl disable mothership
